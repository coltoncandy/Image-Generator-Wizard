...
namespace AlgoManager {
    ...
    void AlgoManager::overlayWrapper(const std::string& bg, const std::string& fg) {
        ...
        Mat blurredImg1 = blurEdgesGaussian(res2, 7, 3);//first integer argument is for side length of grid (so 5 is 5x5 grid centered on pixels). please only use 3, 5, or 7. widthToBlur = how far away from transparent pixels will be blurred.
        ...
        Mat res3 = overlay(background, blurredImg1, Point(0, 0));
