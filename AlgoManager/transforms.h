...
int applyFilter(Mat input, Mat output, int filterWidth, std::vector<std::vector<int>> filter, int toDivide, int x, int y, int inputWidth, int inputHeight, int offset); //apply a filter to one pixel
