...
BackgroundRemoval::BackgroundRemoval(const QString& title, QWidget* parent)
	...
	instructions->setText("<ul>Instructions: <br><li>1. Hold 'ctrl' key and use mouse to draw on areas of background</li><li>3. Hold 'shift' key and use mouse to draw on areas of foreground</li><li>4. Press 'n' to run one iteration of GrabCut</li><li>5. Press 'r' key to start over </li><li>6. Press 'esc' key to continue once satisifed with result</li></ul>");
